...
CREATE USER 'ccruces_user'@'localhost' IDENTIFIED BY 'TU_CONTRASEÑA_SEGURA';
...
3. **Deshabilitar acceso directo a .env:**
   Ya está protegido por Nginx, pero verifica que no sea accesible desde el navegador.

4. **Backups automáticos:**
   ```bash
   # Script de backup (ejemplo básico)
   #!/bin/bash
